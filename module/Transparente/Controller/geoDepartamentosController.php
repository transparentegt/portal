<?php
 ...
 use Transparente\Form\geoDepartamentosForm;
 ...
 class geoDepartamentosController extends AbstractActionController
 {
    ...
    public function addAction()
     {		 
         ...
         if ($request->isPost()) {
             ...
             if ($form->isValid()) {
                 ...
                 return $this->redirect()->toUrl('/transparente/geoDepartamentos');
             }
         }
     ...
     public function editAction()
     {
        ...
        if (!$id) {
            return $this->redirect()->toUrl('/transparente/geoDepartamentos/add');
        }
 ...
 $sm = $this->getServiceLocator();
     ...
     public function deleteAction()
     {
        $id = (int) $this->params()->fromRoute('id', 0);
        if (!$id) {
            return $this->redirect()->toRoute('/transparente/geoDepartamentos', array(
                'action' => 'add'
            ));
        }
        $this->getgeoDepartamentosTable()->deletegeoDepartamentos($id);
		return $this->redirect()->toRoute('/transparente/geoDepartamentos');
     }
